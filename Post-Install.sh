...
sudo dnf -y install lm_sensors vim micro htop btop stress s-tui wget wireshark bind-utils mediawriter distrobox speedtest-cli fastfetch p7zip p7zip-plugins p7zip-gui gh nextcloud-client syncthing android-tools qpdf steam-devices
